...
public class LeageDetails {
    ...
    public String getHome_league_() {
        return home_league_;
    }

    public void setHome_league_(String home_league_) {
        this.home_league_ = home_league_;
    }
